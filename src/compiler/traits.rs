...
impl ToRustType for table::ColumnType {
  fn to_rust_type(&self) -> String {
    let str_type = match &self.type_name {
      ...
      table::ColumnTypeName::Date => format!("types::chrono::NaiveDate"),
      table::ColumnTypeName::Time => format!("types::chrono::NaiveTime"),
      table::ColumnTypeName::Timestamp => format!("types::chrono::NaiveDateTime"),
      table::ColumnTypeName::Timestamptz => format!("types::chrono::DateTime<types::chrono::Local>"),
      table::ColumnTypeName::Uuid => format!("types::Uuid"),
      table::ColumnTypeName::Json => format!("types::JsonValue"),
      table::ColumnTypeName::Decimal => format!("types::Decimal"),
      _ => panic!("database type unsupport"),
    };
